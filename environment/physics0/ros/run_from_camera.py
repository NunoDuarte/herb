...
if __name__ == '__main__':
    ...
    pwd = subprocess.check_output("pwd", shell=True, text=True).strip()
    subprocess.run("/usr/bin/python3 $(pwd)/environment/physics0/ros/realsense_depth_process.py", shell=True)
    ...
    while not terminated:
        ...
        obs_simulated, _, _, _, _ = env.step(action)
